...
public class Controller {
    ...
    private static final String SECRET_ID1 = "rzp_test_3oiHYRXdoQo1zb";
    private static final String SECRET_KEY1 = "z9m5hHfhrVcx0Jh1YSUQwoN4";
    ...
    public OrderResponse createOrder(@RequestBody OrderRequest orderRequest) {
        ...
        try {
            ...
            if (orderRequest.getAmount().intValue() > 1) {
                ...
                System.out.println(response.getPgName());
